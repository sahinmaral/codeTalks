...
interface SendInviteToChannelModalContentProps {
  user: User;
  closeAllModals: () => void;
}

function SendInviteToChannelModalContent({
  user,
  closeAllModals,
}: SendInviteToChannelModalContentProps) {
  ...
  return (
    ...
    >
      ...
      <View>
        ...
        />
        {error.length > 0 && <Text style={styles.modalInputError}>* {error}</Text>}
      </View>
